...
class kvkk : Fragment() {
    ...
    override fun onCreateView(
        ...
        textView.text = "Dillerim uygulaması olarak, 6698 sayılı Kişisel Verilerin Korunması Kanunu (“KVKK”) kapsamında kişisel verilerinizi korumaya önem veriyoruz.\n" +
                "\n" +
                ...
                "\n" +
                "Daha fazla bilgi için bize kvkk@dillerim.com.tr adresinden ulaşabilirsiniz."
